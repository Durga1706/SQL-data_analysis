...
-- GROPU BY: aggregate all rows by a specific col
...
INSERT INTO transactions VALUES  (1000, 4.99, 3, "2023-01-01"), (1001, 2.89, 2, "2023-01-01"), (1002, 3.38, 3, "2023-01-02"),
(1003, 4.99, 1, "2023-01-02"), (1004, 1.00, NULL, "2023-01-03"), (1005, 2.49, 4, "2023-01-03"), (1006, 5.48, NULL, "2023-01-03");
        
SELECT * FROM transactions;
-- tot amount on each day 
...
-- HAVING
-- WHERE clause doesn't work in group by
-- select count(amount), order_date from transactions group by order_date where count(amount)>1;

-- in that place use HAVING
select count(amount), order_date from transactions group by order_date having count(amount)>1;
